...
func getUsers(client *resty.Client) ([]User, error) {
	...
	// обратите внимание, что в этой части кода используется встроенная в resty функция SetResult,
	// она позволяет избежать работы с чтением ответа и обязательной проверки на ошибки,
